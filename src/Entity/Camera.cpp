...
{
	int equalPressed = glfwGetKey(glfwGetCurrentContext(), GLFW_KEY_EQUAL) == GLFW_PRESS;
	int minusPressed = glfwGetKey(glfwGetCurrentContext(), GLFW_KEY_MINUS) == GLFW_PRESS;
	int leftShiftPressed = glfwGetKey(glfwGetCurrentContext(), GLFW_KEY_LEFT_SHIFT)
		== GLFW_PRESS;
